...
((SELECT ID FROM ship WHERE ship.Name = 'New Dawn'), (SELECT ID FROM commodity WHERE commodity.Name = 'Heat_resistant_alloys')),
...
((SELECT ID FROM ship WHERE ship.Name = 'Prometheus'), (SELECT ID FROM commodity WHERE commodity.Name = 'Liquid_manacyte')),
